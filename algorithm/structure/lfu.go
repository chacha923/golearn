...
// 	tail *list.DoubleNode
// }

// func NewFLUCache(capacity int) LFUCache {
// 	return LFUCache{
// 		cache: make(map[int]*list.FreqDequeNode),
...
// func (this *DoubleList) AddFirst(node *list.DoubleNode) {
...
// func (this *DoubleList) Remove(node *list.DoubleNode) {
...
// func (this *DoubleList) RemoveLast() *list.DoubleNode {
// 	if this.IsEmpty() {
// 		return nil
// 	}
